...
public class HexadecimalSudokuTest {
	 ...
	 * @param the
	 *            solution checked
	 * @return null if the two match, and otherwise a sudoku with 0 in every
	 *         cell that differs.
	 */
			...
			if (isFilled(sudoku) && HexadecimalSudoku.checkSudoku(sudoku, true)) {
				...
				if (solution != null) {
					...
					if (diff != null) {
						 ...
						 * the supposed solution is not a complete or valid sudoku
						 */
				if (!isFilled(sudoku)) {
					System.out
							.println("sudoku was not completely filled:\n" + HexadecimalSudoku.toString(sudoku, false));
				}
	...
	public static void main(String[] arg) {
		...
		int[][] triv3 = { { 4, 1, 8, 9, 5, 14, 12, 0, 7, 10, 13, 6, 3, 2, 11, 15 },
				...
				{ 6, 2, 11, 14, 12, 10, 0, 5, 3, 4, 15, 13, 8, 9, 1, 7 },
				{ 0, 5, 10, 7, 14, 13, 2, 1, 11, 9, 12, 8, 15, 4, 3, 6 },
				{ 12, 0, 7, 3, 8, 4, 11, 6, 10, 15, 1, -1, -1, 13, 14, 2 },
				{ 1, 6, 4, 8, 0, 9, 5, 2, 12, 13, 14, 7, 11, 10, 15, 3 },
				{ 2, 11, 14, 5, 13, 15, 10, 12, 0, 6, 4, 3, 9, 1, 7, -1 },
				{ 15, 13, 9, 10, 3, 1, 14, 7, 8, 2, 11, 5, 12, 6, 4, -1 } };
		...
		testSudoku("trivial1", solution1, null);
		testSudoku("trivial2", solution2, solution2);
